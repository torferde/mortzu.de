<?php
  ...
  echo "    <id>" . $protocol . "" . $_SERVER["HTTP_HOST"] . "/</id>\n";
  ...
  foreach($blog as $key => $post) {
    ...
    echo "      <content type=\"html\"><![CDATA[" . strip_tags(str_replace("http://systemfehler.org/files/", $protocol . $_SERVER["HTTP_HOST"] . "/secureimage.php?url=http://systemfehler.org/files/", $post['description']), $config["striptags_feed"]) . "]]></content>\n";
